  ...
  if (_formKey.currentState!.validate()) {
    try {
      ...
      if (userCredential.user != null) {
        ...
        Future.delayed(Duration(seconds: 1), () {
          Navigator.of(context).pushReplacement(
            MaterialPageRoute(builder: (context) => HomePage1()), // Replace with your actual homepage widget
          );
        });
      ...
      showDialog(
        ...
        builder: (context) => AlertDialog(
          title: Text('Sign Up Failed'),
          content: Text('Either email is already taken or the format is incorrect'),
          actions: <Widget>[
            TextButton(
              child: Text('OK'),
              onPressed: () {
